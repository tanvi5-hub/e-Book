package com.example.ebook.read.ui.theme
...
private val DarkColorPalette = ReaderColors(
    brand = Shadow1,
...
class ReaderColors(
    ...
    fun copy(): ReaderColors = ReaderColors(
...
fun ProvideReaderColors(
    ...
    CompositionLocalProvider(LocalReaderColors provides colorPalette, content = content)
}

private val LocalReaderColors = staticCompositionLocalOf<ReaderColors> {
    error("No ReaderColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [ReaderTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
